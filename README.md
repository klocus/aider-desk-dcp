...
**Local installation:**
```bash
curl -fsSL https://raw.githubusercontent.com/klocus/aider-desk-dcp/master/install.sh | bash
```

**Global installation:**
```bash
curl -fsSL https://raw.githubusercontent.com/klocus/aider-desk-dcp/master/install.sh | bash -s -- --global
```
